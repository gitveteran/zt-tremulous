...
//--walls--
vmCvar_t  ZT_Walls_Mode;//default 0(off), 1 for on

//--warn--
vmCvar_t  ZT_Warn_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_Warn_DC;//default 0(off), 1 for on
vmCvar_t  ZT_Warn_Nades;//default 0(off), 1 for on

//--scanner--
vmCvar_t  ZT_Scanner_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_Scanner_Width;//default 75
vmCvar_t  ZT_Scanner_Height;//default 75
vmCvar_t  ZT_Scanner_X;//default 10
vmCvar_t  ZT_Scanner_Y;//default 125
vmCvar_t  ZT_Scanner_Range;//default 2000

//--chamming--
vmCvar_t  ZT_Chamming_Glow;//default 0(off), 1 for on
vmCvar_t  ZT_Chamming_DiffGlow;//default 0(off), 1 for on
vmCvar_t  ZT_Chamming_GlowGren;//default 0(off), 1 for on

//--triggerbot--
vmCvar_t  ZT_Triggerbot_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_Team;//default 0(auto), 1 for human, 2 for alien
vmCvar_t  ZT_Triggerbot_Structures;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_DisableFastGuns;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_GrangerSpit;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_GrangerClaw;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_MaraLightning;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_Cannnon;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_Cannon_ShortRangeOnly;//default 0(off), can specify a distance
vmCvar_t  ZT_Triggerbot_MaraSpit;//default 0(off), 1 for on
vmCvar_t  ZT_Triggerbot_Distance;//default 0

//--ESP--
vmCvar_t  ZT_ESP_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_PlayerInfo_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_BuildHealth_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_Display_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_Display_X;//default 10
vmCvar_t  ZT_ESP_Display_Y;//default 125
vmCvar_t  ZT_ESP_NadeInfo_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_ClassInfo_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_AdvGlow_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_ESP_PainGlow_Mode;//default 0(off), 1 for on

//--aimbot--
vmCvar_t  ZT_Aimbot_Mode;//default 0(off), 1 for on
vmCvar_t  ZT_Aimbot_AutoAim;//default 0(off), 1 for on
vmCvar_t  ZT_Aimbot_Team;//default 0(auto), 1 for aliens, 2 for humans
vmCvar_t  ZT_Aimbot_FieldOfView;//default 15
vmCvar_t  ZT_Aimbot_ThroughWalls;//default 0(off), 1 for on
vmCvar_t  ZT_Aimbot_Unlagged;//default 0
vmCvar_t  ZT_Aimbot_PingPredict;//default -1
vmCvar_t  ZT_Aimbot_WeaponSpeed;//default 0
vmCvar_t  ZT_Aimbot_CutOff;//default 2
...
static cvarTable_t cvarTable[ ] =
{
  ...
  //=====ZT Cvars defaults=====
  //--walls--
    { &ZT_Walls_Mode, "ZT_Walls_Mode", "0", CVAR_ARCHIVE},

  //--warn--
    { &ZT_Warn_Mode, "ZT_Warn_Mode", "0", CVAR_ARCHIVE},
    { &ZT_Warn_DC, "ZT_Warn_DC", "0", CVAR_ARCHIVE},
    { &ZT_Warn_Nades, "ZT_Warn_Nades", "0", CVAR_ARCHIVE},

  //--scanner--
    { &ZT_Scanner_Mode, "ZT_Scanner_Mode", "0", CVAR_ARCHIVE},
    { &ZT_Scanner_Width, "ZT_Scanner_Width", "75", CVAR_ARCHIVE},
    { &ZT_Scanner_Height, "ZT_Scanner_Height", "75", CVAR_ARCHIVE},
    { &ZT_Scanner_X, "ZT_Scanner_X", "10", CVAR_ARCHIVE},
    { &ZT_Scanner_Y, "ZT_Scanner_Y", "125", CVAR_ARCHIVE},
    { &ZT_Scanner_Range, "ZT_Scanner_Range", "2000", CVAR_ARCHIVE},

  //--chamming--
    { &ZT_Chamming_Glow, "ZT_Chamming_Glow", "0", CVAR_ARCHIVE},
    { &ZT_Chamming_DiffGlow, "ZT_Chamming_DiffGlow", "0", CVAR_ARCHIVE},
    { &ZT_Chamming_GlowGren, "ZT_Chamming_GlowGren", "0", CVAR_ARCHIVE},

  //--triggerbot--
    { &ZT_Triggerbot_Mode, "ZT_Triggerbot_Mode", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_Team, "ZT_Triggerbot_Team", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_Structures, "ZT_Triggerbot_Structures", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_DisableFastGuns, "ZT_Triggerbot_DisableFastGuns", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_GrangerSpit, "ZT_Triggerbot_GrangerSpit", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_GrangerClaw, "ZT_Triggerbot_GrangerClaw", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_MaraLightning, "ZT_Triggerbot_MaraLightning", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_Cannnon, "ZT_Triggerbot_Cannnon", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_Cannon_ShortRangeOnly, "ZT_Triggerbot_Cannon_ShortRangeOnly", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_MaraSpit, "ZT_Triggerbot_MaraSpit", "0", CVAR_ARCHIVE},
    { &ZT_Triggerbot_Distance, "ZT_Triggerbot_Distance", "0", CVAR_ARCHIVE},

  //--ESP--
    { &ZT_ESP_Mode, "ZT_ESP_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_PlayerInfo_Mode, "ZT_ESP_PlayerInfo_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_BuildHealth_Mode, "ZT_ESP_BuildHealth_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_Display_Mode, "ZT_ESP_Display_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_Display_X, "ZT_ESP_Display_X", "10", CVAR_ARCHIVE},
    { &ZT_ESP_Display_Y, "ZT_ESP_Display_Y", "125", CVAR_ARCHIVE},
    { &ZT_ESP_NadeInfo_Mode, "ZT_ESP_NadeInfo_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_ClassInfo_Mode, "ZT_ESP_ClassInfo_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_AdvGlow_Mode, "ZT_ESP_AdvGlow_Mode", "0", CVAR_ARCHIVE},
    { &ZT_ESP_PainGlow_Mode, "ZT_ESP_PainGlow_Mode", "0", CVAR_ARCHIVE},

  //--aimbot--
  	{ &ZT_Aimbot_Mode, "ZT_Aimbot_Mode", "0", CVAR_ARCHIVE},
    { &ZT_Aimbot_AutoAim, "ZT_Aimbot_AutoAim", "0", CVAR_ARCHIVE},
    { &ZT_Aimbot_Team, "ZT_Aimbot_Team", "0", CVAR_ARCHIVE},
    { &ZT_Aimbot_FieldOfView, "ZT_Aimbot_FieldOfView", "15", CVAR_ARCHIVE},
    { &ZT_Aimbot_ThroughWalls, "ZT_Aimbot_ThroughWalls", "0", CVAR_ARCHIVE},
    { &ZT_Aimbot_Unlagged, "ZT_Aimbot_Unlagged", "0", CVAR_ARCHIVE},
    { &ZT_Aimbot_PingPredict, "ZT_Aimbot_PingPredict", "-1", CVAR_ARCHIVE},
    { &ZT_Aimbot_WeaponSpeed, "ZT_Aimbot_WeaponSpeed", "0", CVAR_ARCHIVE},
    { &ZT_Aimbot_CutOff, "ZT_Aimbot_CutOff", "2", CVAR_ARCHIVE},
