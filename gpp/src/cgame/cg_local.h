...
//--walls--
extern  vmCvar_t    ZT_Walls_Mode;//default 0(off), 1 for on

//--warn--
extern vmCvar_t     ZT_Warn_Mode;//default 0(off), 1 for on
extern vmCvar_t     ZT_Warn_DC;//default 0(off), 1 for on
extern vmCvar_t     ZT_Warn_Nades;//default 0(off), 1 for on

//--scanner--
extern  vmCvar_t    ZT_Scanner_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Scanner_Width;//default 75
extern  vmCvar_t    ZT_Scanner_Height;//default 75
extern  vmCvar_t    ZT_Scanner_X;//default 10
extern  vmCvar_t    ZT_Scanner_Y;//default 125
extern  vmCvar_t    ZT_Scanner_Range;//default 2000

//--chamming--
extern  vmCvar_t    ZT_Chamming_Glow;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Chamming_DiffGlow;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Chamming_GlowGren;//default 0(off), 1 for on

//--triggerbot--
extern	vmCvar_t    ZT_Triggerbot_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_Team;//default 0(auto), 1 for human, 2 for alien
extern  vmCvar_t    ZT_Triggerbot_Structures;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_DisableFastGuns;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_GrangerSpit;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_GrangerClaw;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_MaraLightning;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_Cannnon;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_Cannon_ShortRangeOnly;//default 0(off), can specify a distance
extern  vmCvar_t    ZT_Triggerbot_MaraSpit;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Triggerbot_Distance;//default 0

//--ESP--
extern  vmCvar_t    ZT_ESP_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_PlayerInfo_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_BuildHealth_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_Display_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_Display_X;//default 10
extern  vmCvar_t    ZT_ESP_Display_Y;//default 125
extern  vmCvar_t    ZT_ESP_NadeInfo_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_ClassInfo_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_AdvGlow_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_ESP_PainGlow_Mode;//default 0(off), 1 for on


//--aimbot--
extern  vmCvar_t    ZT_Aimbot_Mode;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Aimbot_AutoAim;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Aimbot_Team;//default 0(auto), 1 for aliens, 2 for humans
extern  vmCvar_t    ZT_Aimbot_FieldOfView;//default 15
extern  vmCvar_t    ZT_Aimbot_ThroughWalls;//default 0(off), 1 for on
extern  vmCvar_t    ZT_Aimbot_Unlagged;//default 0
extern  vmCvar_t    ZT_Aimbot_PingPredict;//default -1
extern  vmCvar_t    ZT_Aimbot_WeaponSpeed;//default 0
extern  vmCvar_t    ZT_Aimbot_CutOff;//default 2
...
void CG_BuildableStatusDisplay( centity_t *cent );
...
//cg_syscall.c
void trap_ZTMoveAim( float *y, float *p);
void trap_ZTAimbutton( int *b);

qboolean trap_R_inPVS( const vec3_t p1, const vec3_t p2 );//TODO ????? what was this about
