export ZT_AdvGlowDiff
code
proc ZT_AdvGlowDiff 4 0
ADDRLP4 0
ADDRFP4 4
INDIRP4
CNSTI4 188
...
BANDI4
ASGNI4
ADDRGP4 ZT_ESP_AdvGlow_Mode+12
INDIRI4
CNSTI4 1
EQI4 $118
ADDRGP4 $117
...
LABELV $121
LABELV $117
endproc ZT_AdvGlowDiff 4 0
export ZT_PainGlowDiff
proc ZT_PainGlowDiff 12 12
ADDRLP4 0
ADDRFP4 4
INDIRP4
CNSTI4 192
...
INDIRI4
ASGNI4
ADDRGP4 ZT_ESP_PainGlow_Mode+12
INDIRI4
CNSTI4 1
EQI4 $126
ADDRGP4 $125
...
LABELV $129
LABELV $125
endproc ZT_PainGlowDiff 12 12
export ZT_RenderPlayer
proc ZT_RenderPlayer 12 8
ADDRFP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
INDIRP4
ARGP4
ADDRGP4 ZT_TargetGlow
CALLV
pop
LABELV $137
LABELV $134
endproc ZT_RenderPlayer 12 8
export ZT_RenderBuildable
proc ZT_RenderBuildable 0 4
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 ZT_WallHack
...
pop
LABELV $139
endproc ZT_RenderBuildable 0 4
export ZT_RenderMissile
proc ZT_RenderMissile 4 4
ADDRLP4 0
ADDRFP4 4
INDIRP4
CNSTI4 192
...
INDIRP4
ARGP4
ADDRGP4 ZT_SeeGrenade
CALLV
pop
LABELV $141
LABELV $140
endproc ZT_RenderMissile 4 4
