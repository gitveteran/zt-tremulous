...
qhandle_t RE_RegisterShader( const char *name ) {
	...
	if ( /*(strcmp(name, "gfx/misc/greenbuild") == 0) ||
		 (strcmp(name, "gfx/misc/redbuild") == 0) ||
		 (strcmp(name, "gfx/misc/nopower") == 0) ||
		 (strcmp(name, "gfx/misc/shadow") == 0) ||
		 (strcmp(name, "gfx/damage/fullscreen_painblend") == 0)  ||*/
		 (strstr(name, "gfx") > 0 )
	   )
	{
		sh->sort = SS_NEAREST;
