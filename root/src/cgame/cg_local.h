...
//ZT added
void CG_PlayerAngles( centity_t *cent, vec3_t srcAngles, vec3_t legs[ 3 ], vec3_t torso[ 3 ], vec3_t head[ 3 ] );
void CG_PlayerNonSegAngles( centity_t *cent, vec3_t srcAngles, vec3_t nonSegAxis[ 3 ] );
void CG_PlayerWWSmoothing( centity_t *cent, vec3_t in[ 3 ], vec3_t out[ 3 ] );
...
void        CG_BuildableHealthBar( centity_t *cent );//added for ZT
...
void trap_SetSmooth( float *y, float *p );
void trap_SmoothSpeedX( float *x );
void trap_SmoothSpeedY( float *y );
void trap_SmoothState( int *s );
